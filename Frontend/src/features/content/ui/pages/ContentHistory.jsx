...
import { searchContentApi } from "../../api/contentApi";
const ContentHistory = () => {
  ...
  async function searchContent(){
    try {
        setIsLoading(true);
        const res = await searchContentApi(searchQuery);
        return res;
    } catch (error) {
        console.log(error);
    }
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3">
                      ...
                      >
                        {capitalizeWord(item?.content_type)}
                      </span>
                  ...
                  <div className="flex gap-3">
                    <button
                      onClick={() => {
                        navigate(`/main/content/content-details/${item._id}`);
                      }}
