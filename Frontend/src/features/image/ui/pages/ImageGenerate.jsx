...
import { IMAGE_RESOLUTION } from "../../../../shared/ui/components/constant";
import {
  Download,
  DropDown,
  ErrorIcon,
...
const ImageGenerate = () => {
  ...
  const {error, setError, generatedImage, setGeneratedImage, submitHandler, register, reset, handleSubmit, errors, isLoading, isSubmitting, setIsLoading, setIsSubmitting} = useImage()
